...
CREATE TABLE IF NOT EXISTS Orders (
    OrdersId INT UNSIGNED PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS Payment (
    ...
    FOREIGN KEY (OrderId) REFERENCES Orders(OrdersId) ON Delete CASCADE On UPDATE CASCADE 
)
''')

# Tạo bảng EmployeePerformance
cursor.execute('''
CREATE TABLE IF NOT EXISTS PerformanceEvaluationSale (
    PerformanceEvaluationSaleId INT UNSIGNED PRIMARY KEY,
...
# Tạo bảng KPI
cursor.execute('''
CREATE TABLE IF NOT EXISTS KPISale (
    KPISaleID INT UNSIGNED PRIMARY KEY,
    Employee INT UNSIGNED NOT NULL,
    Date DATE NOT NULL,
    WorkPerformanceScore INT UNSIGNED NOT NULL,
    ConsciousnessScore INT UNSIGNED NOT NULL,
